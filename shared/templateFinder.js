...
module.exports = function(Underscore) {
  ...
  /**
   * Given a template name, return the compiled Underscore template.
   */
  function getTemplate(templateName) {
    ...
    */
    if (!cachedTemplates[src]) {
       ...
       * The `grunt-contrib-Underscore` module  produces different stucture
      ...
      if (typeof cachedTemplates[src] == 'function') {
        cachedTemplates[src] = cachedTemplates[src](Underscore);
      }
    }
